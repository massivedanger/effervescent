...
},{"./wintermute/component":2,"./wintermute/entity":3,"./wintermute/family":4,"./wintermute/game":5,"./wintermute/input":6,"./wintermute/sprite":10,"./wintermute/system":12,"./wintermute/vector2":13,"pixi.js":15,"zepto-browserify":16}],2:[function(require,module,exports){
var Component;
...
Game = (function() {
  function Game(options) {
    ...
    if (PIXI && Zepto) {
      this.server = false;
      this.container = Zepto.$(options.container);
  ...
  Game.prototype.run = function() {
    ...
    while (this.running) {
      time = Date.now();
      this.deltaTime = time - (this.deltaTime || time);
      this.update();
...
},{"./state":11,"lodash":14,"pixi.js":15,"zepto-browserify":16}],6:[function(require,module,exports){
...
},{"../vector2":13}],9:[function(require,module,exports){
var Signal,
  __slice = [].slice;
...
},{"./family":4,"lodash":14}],12:[function(require,module,exports){
var System;
