...
},{"./wintermute/component":2,"./wintermute/entity":3,"./wintermute/family":4,"./wintermute/game":5,"./wintermute/sprite":6,"./wintermute/system":7,"./wintermute/vector2":8,"pixi.js":9,"zepto-browserify":10}],2:[function(require,module,exports){
var Component;
...
Entity = (function() {
  ...
  Entity.prototype.addComponent = function(component) {
    ...
    return this.onComponentAdded.emit(componentName);
  };
...
Family = (function() {
  ...
  Family.prototype.addEntityIfMatch = function(entity) {
    if (!(__indexOf.call(this._entities, entity) >= 0) && this._matchEntity(entity)) {
  ...
  Family.prototype.onComponentAdded = function(entity, componentName) {
    return this.addEntityIfMatch(entity);
  };
  ...
  Family._matchEntity = function(entity) {
...
},{"./family":4}],6:[function(require,module,exports){
var Sprite;
